namespace tpAgencia_Gpo_2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Agencia = new Agencia();
            Agencia.setUsuario(new Usuario(1, "pepe", "popo", "29111222", "Juan@pepe.com", "1234", true, 500000));
            Agencia.setUsuario(new Usuario(2, "juana", "lola", "33333333", "Juana@lola.com", "1234", true, 500000));
            Agencia.setUsuario(new Usuario(3, "pablo", "lopez", "22222222", "Pablo@lopez.com", "1234", true, 500000));
            ...
            Agencia.agregarVuelo(Agencia.GetCiudades()[0], Agencia.GetCiudades()[1], 2, 200000, new DateTime(2023, 10, 10), "JetSmart", "Airbus300");
